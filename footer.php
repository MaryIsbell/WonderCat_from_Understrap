        ...
        <div class="container"> <!-- Bootstrap container for consistent spacing -->
            <div class="row justify-content-between align-items-center">
                ...
                <div class="col-auto wc-footer-right text-end">
                    <a href="https://github.com/MaryIsbell/WonderCat_from_Understrap" target="_blank" rel="noopener noreferrer">Powered by WordPress and WikiData | WonderCat Theme</a>
                </div>
