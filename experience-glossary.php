<?php
/**
 * Template Name: Experience Glossary Template
 *
 * A custom page to display terms from the experience taxonomy, split into normal and combination terms,
...
<div class="wrapper" id="experience-glossary-wrapper">
    <div class="<?php echo esc_attr( $container ); ?>" id="content" tabindex="-1">
        <div class="row">
            ...
            <main class="site-main col" id="main">
                ...
                // Fetch all top-level experience terms alphabetically
                $all_terms = get_terms([
                    'taxonomy'   => $taxonomy,
                    'hide_empty' => false,
                    'orderby'    => 'name',
    ...
    echo '<thead>
            <tr>
                ...
                render_glossary_table( $normal_terms, 'Experience Terms', $version_history_page );
...
</div><!-- #experience-glossary-wrapper -->
